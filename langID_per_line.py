...
def main():
    ...
    OUTPUT_STATS_FILE = "line_counts_" + Path(INPUT_FILE).name  # Output (1) - stats file with line counts, sorted by file/page
    OUTPUT_LINES_FILE = "pages_classified_" + Path(INPUT_FILE).name  # Output (2) - detailed CSV with all lines, sorted by file/page/category
